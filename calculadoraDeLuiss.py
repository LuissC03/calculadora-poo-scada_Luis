...
def main(page: ft.Page):
    ...
    operation_display = ft.Text(value="", color=ft.Colors.WHITE54, size=14, font_family="nose hola")
    result = ft.Text(value="0", color=ft.Colors.WHITE, size=20, font_family="nose hola")
